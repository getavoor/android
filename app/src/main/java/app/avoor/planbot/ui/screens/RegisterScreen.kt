    ...
    Scaffold (
        topBar = {
            LargeTopAppBar(
                title = {
                    Text(
                        stringResource(id = R.string.nux_register_title),
                        maxLines = 1,
        ...
        bottomBar = {
            TwoButtons(
                ...
                positiveText = stringResource(R.string.login_button_reg),
                negativeAction = {
                    navigator.goBack()
                },
                disablePositive = !(
                    // the password is valid
                    viewState.passwordError == null
                        // and matches the confirm password
                        && viewState.passwordsMatch
        ...
        Column(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.login_input_name)) },
                    singleLine = true,
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                OutlinedTextField(
                    ...
                    isError = (!viewState.emailValid && viewState.email != ""),
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(
                            stringResource(
                                if (viewState.passwordError != null) viewState.passwordError!!
                                else R.string.login_input_password
                            )
                        )
                    },
                    trailingIcon = {
                ...
                OutlinedTextField(
                    ...
                    singleLine = true,
                    visualTransformation =
                        if (viewState.showConfirmPassword) VisualTransformation.None else PasswordVisualTransformation(),
                    isError = !viewState.passwordsMatch,
                    label = {
                        Text(
                            stringResource(
                                if (viewState.passwordsMatch) R.string.login_input_password_confirm
                                else R.string.login_password_no_match
                            )
                        )
                    },
                    trailingIcon = {
                        val image = ImageVector.vectorResource(
                            if (viewState.showConfirmPassword) R.drawable.ic_visibility_off
                            else R.drawable.ic_visibility
                        )

                        // Please provide localized description for accessibility services
                        val description =
                            if (viewState.showConfirmPassword)
                                stringResource(R.string.login_input_password_hide)
                            else
                                stringResource(R.string.login_input_password_show)
